...
def end_convo():
    ...
    try:
        ...
        f = f"DataAnlysis/log/{agent_app.global_models[model_idx]['key']}_{characters[char_idx]['name']}_{session_id}_{datetime.datetime.now().strftime('%Y-%m-%d_%H-%M')}.csv" #Set file path
